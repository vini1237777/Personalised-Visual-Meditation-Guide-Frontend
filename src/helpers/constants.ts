...
> = {
  Joy: [
    "https://generativelanguage.googleapis.com/download/v1beta/files/qw3zgygxm643:download?alt=media&key=AIzaSyBrsnbKgJLhEBRFKq0sC0ezVuap4SCuIqc",
    "https://generativelanguage.googleapis.com/download/v1beta/files/vgvxaia6vx39:download?alt=media&key=AIzaSyBrsnbKgJLhEBRFKq0sC0ezVuap4SCuIqc",
  ],
  Sadness: [
